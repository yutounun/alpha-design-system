...
DESCRIPTIONS: dict[str, str] = {
    ...
    "--color-focus-ring": "Semi-transparent focus ring derived from focus for ring utilities.",
    ...
    "--color-secondary-hover": "Secondary fill hover state (mixed toward black).",
    "--color-secondary-active": "Secondary fill active state (mixed toward black).",
    ...
    "--color-danger-button-border": "Destructive button default border.",
    "--color-danger-button-border-hover": "Destructive button border on hover.",
    "--color-danger-button-bg-hover": "Destructive button translucent fill on hover.",
    "--color-danger-button-focus-border": "Destructive control focus border.",
    "--color-danger-button-focus-ring": "Destructive control focus ring.",
    "--color-invalid-ring": "Form validation error focus ring.",
    "--color-invalid-border-muted": "Muted invalid border for dark or low-contrast contexts.",
